...
#define GPU_MAX_FREQ			800000
#define GPU_MIN_FREQ			104000
...
/*tshark 28nm*/
	.dfs_freq_list=
	{
		/*index:  0 freq:500000 freq_select:  6  div_select:  1*/
		&dfs_freq_full_list[0],
		/*index:  1 freq:460800 freq_select:  5  div_select:  1*/
		&dfs_freq_full_list[4],
		/*index:  2 freq:412000 freq_select:  4  div_select:  1*/
		&dfs_freq_full_list[8],
		/*index:  3 freq:356000 freq_select:  2  div_select:  1*/
		&dfs_freq_full_list[12],
		/*index:  4 freq:300000 freq_select:  1  div_select:  1*/
		&dfs_freq_full_list[16],
		/*index:  5 freq:253600 freq_select:  0  div_select:  1*/
		&dfs_freq_full_list[20],
		/*index:  6 freq:1524000 freq_select:  1  div_select:  2*/
		&dfs_freq_full_list[17],
		/*index:  7 freq:104000  freq_select:  2  div_select:  4*/
...
int gpufreq_min_limit=104000;
int gpufreq_max_limit=500000;

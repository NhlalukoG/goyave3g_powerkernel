...
namespace WebCore {
//AndroidJB4.3 Merge  - START
//class MediaListener : public android::SurfaceTexture::FrameAvailableListener { //Removed in 4.3 Merge
class MediaListener : public android::GLConsumer::FrameAvailableListener {	
//AndroidJB4.3 Merge  - END
public:
    MediaListener(jobject weakWebViewRef,
		//AndroidJB4.3 Merge  - START
              //   const sp<android::SurfaceTexture>& surfaceTexture, //Removed in 4.3 Merge
...
//AndroidJB4.3 Merge  - START	
  //  sp<android::SurfaceTexture> m_surfaceTexture; //Removed in 4.3 Merge
